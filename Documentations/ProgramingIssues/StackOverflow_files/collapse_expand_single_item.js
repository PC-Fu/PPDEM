...
Place this in your HTML
	<img src="/IMAGESDIR/u.gif" name="imgfirst" width="9" height="9" border="0" >	<a  href="#first" onClick="shoh('first');" >Customer Support</a>
...
/////////////////BEGIN USER EDITABLE///////////////////////////////
	imgout.src="/isn/Community/en-us/Utility/images/u.gif";
	imgin.src="/isn/Community/en-us/Utility/images/d.gif";
///////////////END USER EDITABLE///////////////////////////////////
...
function shoh(id) { 
	...
	if ( readCookie("CSCollapsed") == null)
	{
		createCookie( "CSCollapsed", "no");
	} 
	...
	if (document.getElementById) { // DOM3 = IE5, NS6
		if (document.getElementById(id).style.display == "none"){
			...
			filter(("img"+id),'imgin');			
			document.getElementById("add177px").style.width = '800px';
		} else {
			createCookie( "CSCollapsed", "yes");
			filter(("img"+id),'imgout');
			document.getElementById(id).style.display = 'none';			
			document.getElementById("add177px").style.width = '977px';
		}	
	} else { 
		if (document.layers) {	
			if (document.id.display == "none"){
				...
				filter(("img"+id),'imgin');
				document.add177px.style.width = '800px';
			} else {
				createCookie( "CSCollapsed", "yes");
				filter(("img"+id),'imgout');	
				document.id.display = 'none';
				document.add177px.style.width = '977px';
			}
		} else {
