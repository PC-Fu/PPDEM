...
if(zAC)zc(1,'zFS=',zFS,99999999,gs);if(this.zAth&&zAth.length>0&&(zAth!=zAthG))zPxT('a='+zAth+'&ag='+zAthG+'&u='+zWl)
...
google_ad_output='js'
google_max_num_ads=isNaN(this.zGL)?8:zGL
