    ...
    var objLIs = document.getElementById("HAT-subheader").getElementsByTagName("li");
      ...
      if (objULs.length > 0)
      {
        ...
        { 
          ...
          this.getElementsByTagName("ul")[0].style.top = '29px';
        }
...
HAT.GlobalheadingLUT = {
    sub:[
      ...
      },
      {
        ...
        id:'HAT-gh2',
        path:[
          {value:'http://www.intel.com/support/'},
          {value:'http://www.intel.com/services/'}
        ]
      },
      {
        /*about*/
        id:'HAT-gh3',
        path:[
          {value:'http://www.intel.com/community/'},
          {value:'http://www.intel.com/corporate/'},
          {value:'http://www.intel.com/education/'},
          {value:'http://www.intel.com/events/'},
          {value:'http://www.intel.com/intel/'},
          {value:'http://www.intel.com/intelpress/'},
          {value:'http://www.intel.com/jobs/'},
          {value:'http://www.intel.com/museum/'},
          {value:'http://www.intel.com/news/'},
          {value:'http://www.intel.com/policy/'},
          {value:'http://www.intel.com/pressroom/'}
        ]
      },
      {
        id:'HAT-gh4',
        path:[
          {value:'http://www.intel.com/intel/nav/'}
        ]
      }
    ]
  };
...
if(window.devicePixelRatio) {
	$(document).ready(function(){
		$("#HAT-subheader a").css("font-size", "14px");
		$("#sitewide > h1 > a").css("font-size", "17px");
	});
}
